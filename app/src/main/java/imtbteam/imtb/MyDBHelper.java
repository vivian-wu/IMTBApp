...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C054', '天使', '獲得企業贊助，當月收入增加  1,500 元', 1500)");
        ...
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C064', '天使', '獲得 企業在助，每月收入增加  500 元', 0)");
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C065', '天使', '增加  當月薪水 20 ％現金', 0)");
        ...
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C068', '惡魔', '員工意外受傷需休養一個，因人手不足導致顧客流失，當月收入損失 2,000 元', -2000)");
        ...
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C072', '惡魔', '創業太勞累，醫藥費支付300 元', -300)");
        ...
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C076', '惡魔', '被政府課稅，本月營業額減少 500 元', 0)");
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C077', '惡魔', '損失當月薪水 20 ％現金', 0)");
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C078', '惡魔', '生財器具損壞，當月營業額損失 2 ％', 0)");
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C079', '惡魔', '水電費 調漲，每位玩家每月支出多 500 元', 0)");
        db.execSQL("INSERT INTO CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C080', '惡魔', '颱風天，公司無法正常營業，所有玩家當月收入減少 200 元', 0)");
