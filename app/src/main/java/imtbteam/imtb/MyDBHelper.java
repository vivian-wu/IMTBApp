...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C054', '天使', '獲得企業贊助，獲得現金 15000 元。', 15000)");
        ...
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C064', '天使', '獲得企業贊助，獲得現金 50000 元', 50000)");
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C065', '天使', '增加當月收入 5,000。', 5000)");
        ...
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C068', '惡魔', '員工意外受傷需休養一個，支付員工保健費用 2000 元', -2000)");
        ...
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C072', '惡魔', '創業太勞累，醫藥費支付 300 元', -300)");
        ...
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C076', '惡魔', '被政府課稅，支付稅收費用 500 元。', -500)");
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C077', '惡魔', '生財器具損壞，支付修繕費用 3,000元。', -3000)");
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C078', '惡魔', '空調報修，支付修繕費用 5,000 元。', -5000)");
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C079', '惡魔', '夏日水電費暴增，每位玩家支出 500 元水電費。', -500)");
        db.execSQL("INSERT INTO CARD_CARD (CardNo, CardCategory, CardContent, CashAmount) values( 'C080', '惡魔', '颱風天，公司無法正常營業，所有玩家損失 2,000 元', -2000)");
